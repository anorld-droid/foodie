...
var paragraphsPost1 = [
  ...
  Paragraph(
      ...
      [Markup(MarkupType.italic, 41, 72, null)]),
  Paragraph(
      ParagraphType.text,
      "In this particular case our settings.gradle becomes:",
      [Markup(MarkupType.code, 28, 43, null)]),
...
var paragraphsPost2 = [
  ...
  Paragraph(
      ...
      [
        Markup(MarkupType.link, 92, 97,
            "https://github.com/google/dagger/releases/tag/dagger-2.18"),
        Markup(MarkupType.link, 165, 170,
  ...
  Paragraph(
      ...
      [Markup(MarkupType.code, 41, 53, null)]),
  Paragraph(
      ParagraphType.text,
      ...
      [Markup(MarkupType.code, 81, 97, null)]),
  Paragraph(ParagraphType.text, "Qualifiers for field attributes", []),
  Paragraph(ParagraphType.text, "", [Markup(MarkupType.link, 0, 0, null)]),
  Paragraph(
      ParagraphType.text,
      ...
      [
        Markup(MarkupType.code, 181, 187, null),
        Markup(MarkupType.link, 268, 285,
            "http://frogermcs.github.io/dependency-injection-with-dagger-2-custom-scopes/"),
        Markup(MarkupType.italic, 114, 119, null),
        Markup(MarkupType.italic, 143, 149, null)
      ]),
  Paragraph(ParagraphType.text,
  ...
  Paragraph(
      ...
      [Markup(MarkupType.bold, 8, 29, null)]),
  ...
  Paragraph(ParagraphType.codeBlock, """
        ...
        """, [Markup(MarkupType.bold, 65, 95, null)]),
  Paragraph(
      ParagraphType.text,
      ...
      [Markup(MarkupType.code, 18, 24, null)]),
  Paragraph(
  ...
  Paragraph(
      ...
      [
        Markup(MarkupType.code, 51, 60, null),
        Markup(MarkupType.code, 73, 79, null),
        Markup(MarkupType.code, 121, 127, null),
        Markup(MarkupType.code, 141, 146, null),
        Markup(MarkupType.code, 178, 188, null),
        Markup(MarkupType.bold, 200, 213, null),
        Markup(MarkupType.italic, 200, 213, null)
      ]),
  Paragraph(
      ParagraphType.text,
      ...
      [
        Markup(MarkupType.code, 60, 70, null),
        Markup(MarkupType.code, 121, 128, null)
      ]),
  Paragraph(
      ParagraphType.text,
  ...
  Paragraph(
      ...
      [
        Markup(MarkupType.code, 184, 193, null),
        Markup(MarkupType.code, 216, 233, null),
        Markup(MarkupType.link, 132, 146,
  ...
  Paragraph(
      ...
      [
        Markup(MarkupType.code, 95, 116, null),
        Markup(MarkupType.link, 66, 75,
            "https://en.wikipedia.org/wiki/Class_invariant"),
        Markup(MarkupType.link, 96, 116,
  ...
  Paragraph(ParagraphType.codeBlock, """
        ...
        """, [Markup(MarkupType.bold, 72, 93, null)]),
  ...
  Paragraph(
      ...
      [
        Markup(MarkupType.code, 155, 162, null),
        Markup(MarkupType.code, 225, 246, null)
      ]),
  Paragraph(
      ParagraphType.text,
      ...
      [Markup(MarkupType.code, 185, 194, null)])
];
...
var paragraphsPost3 = [
  ...
  Paragraph(
      ...
      [
        Markup(MarkupType.code, 26, 30, null),
        Markup(MarkupType.code, 37, 47, null)
      ]),
  Paragraph(
      ParagraphType.text,
      ...
      [
        Markup(MarkupType.code, 245, 251, null),
        Markup(MarkupType.code, 359, 365, null),
...
var paragraphsPost4 = [
  ...
  Paragraph(
      ...
      [Markup(MarkupType.bold, 183, 197, null)]),
  Paragraph(
      ParagraphType.text,
      ...
      [
        Markup(MarkupType.code, 0, 16, null),
        Markup(MarkupType.code, 34, 43, null),
        Markup(MarkupType.bold, 209, 303, null)
      ]),
  Paragraph(
      ParagraphType.text,
      "Let’s look at an example based on this issue in the tracker: Updating ViewModel on system locale change.",
      [
        Markup(MarkupType.link, 61, 103,
            "https://issuetracker.google.com/issues/111961971"),
        Markup(MarkupType.italic, 61, 104, null)
      ]),
  Paragraph(
      ParagraphType.text,
      ...
      [Markup(MarkupType.bold, 73, 133, null)]),
  Paragraph(
      ParagraphType.text,
      ...
      [
        ...
        Markup(MarkupType.link, 28, 36,
            "https://issuetracker.google.com/issues/111961971#comment2"),
        Markup(MarkupType.bold, 82, 150, null)
      ]),
  Paragraph(
      ParagraphType.text,
...
var paragraphsPost5 = [
  Paragraph(
      ...
      [
        Markup(MarkupType.code, 210, 220, null),
        Markup(MarkupType.code, 241, 249, null),
        Markup(MarkupType.link, 210, 221,
            "https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/index.html"),
        Markup(MarkupType.link, 241, 250,
            "https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.sequences/index.html"),
        Markup(MarkupType.bold, 130, 134, null),
        Markup(MarkupType.bold, 195, 202, null),
        Markup(MarkupType.bold, 227, 233, null),
        Markup(MarkupType.italic, 130, 134, null)
      ]),
  ...
  Paragraph(
      ...
      [Markup(MarkupType.italic, 57, 61, null)]),
  Paragraph(
      ParagraphType.text,
      ...
      [
        Markup(MarkupType.code, 229, 232, null),
        Markup(MarkupType.code, 273, 279, null),
        Markup(MarkupType.code, 309, 318, null),
        Markup(MarkupType.link, 183, 199,
            "https://kotlinlang.org/docs/reference/inline-functions.html"),
        Markup(MarkupType.link, 229, 232,
            "https://github.com/JetBrains/kotlin/blob/master/libraries/stdlib/common/src/generated/_Collections.kt#L1312"),
        Markup(MarkupType.bold, 0, 12, null),
        Markup(MarkupType.italic, 16, 23, null)
      ]),
  Paragraph(
      ParagraphType.codeBlock,
      "public inline fun <T, R> Iterable<T>.map(transform: (T) -> R): List<R> {\n  return mapTo(ArrayList<R>(collectionSizeOrDefault(10)), transform)\n}",
      [
        Markup(MarkupType.bold, 7, 13, null),
        Markup(MarkupType.bold, 88, 97, null)
      ]),
  Paragraph(
      ParagraphType.text,
      ...
      [
        Markup(MarkupType.code, 357, 360, null),
        Markup(MarkupType.code, 362, 370, null),
        Markup(MarkupType.code, 372, 379, null),
        Markup(MarkupType.code, 443, 448, null),
        Markup(MarkupType.code, 450, 456, null),
        Markup(MarkupType.code, 458, 463, null),
        Markup(MarkupType.bold, 0, 9, null),
        Markup(MarkupType.bold, 67, 79, null),
        Markup(MarkupType.bold, 84, 92, null),
        Markup(MarkupType.bold, 254, 269, null),
        Markup(MarkupType.italic, 14, 20, null)
      ]),
  Paragraph(
      ParagraphType.text,
  ...
  Paragraph(
      ...
      [
        Markup(MarkupType.code, 222, 225, null),
        Markup(MarkupType.code, 312, 320, null),
        Markup(MarkupType.link, 222, 225,
  ...
  Paragraph(
      ...
      [
        Markup(MarkupType.code, 34, 54, null),
        Markup(MarkupType.code, 68, 71, null)
      ]),
  Paragraph(
      ParagraphType.codeBlock,
      "internal class TransformingIndexedSequence<T, R> \n constructor(private var sequence: Sequence<T>, private var transformer: (Int, T) -> R) : Sequence<R> {",
      [Markup(MarkupType.bold, 109, 120, null)]),
  Paragraph(
      ParagraphType.codeBlock,
      "override fun iterator(): Iterator<R> = object : Iterator<R> {\n   …\n   override fun next(): R {\n     return transformer(checkIndexOverflow(index++), iterator.next())\n   }\n   …\n}",
      [
        Markup(MarkupType.bold, 83, 89, null),
        Markup(MarkupType.bold, 107, 118, null)
      ]),
  Paragraph(
      ParagraphType.text,
      ...
      [
        Markup(MarkupType.code, 145, 149, null),
        Markup(MarkupType.code, 151, 157, null),
        Markup(MarkupType.code, 159, 166, null),
        Markup(MarkupType.link, 193, 207,
  ...
  Paragraph(
      ...
      [Markup(MarkupType.code, 0, 10, null)]),
  Paragraph(
      ParagraphType.bullet,
      ...
      [
        Markup(MarkupType.code, 0, 3, null),
        Markup(MarkupType.bold, 130, 133, null)
      ]),
  Paragraph(
      ParagraphType.bullet,
  ...
  Paragraph(
      ...
      [
        Markup(MarkupType.code, 122, 127, null),
        Markup(MarkupType.code, 157, 160, null),
        Markup(MarkupType.code, 197, 200, null)
      ]),
  Paragraph(
      ParagraphType.text,
  ...
  Paragraph(
      ...
      [Markup(MarkupType.code, 202, 210, null)]),
  Paragraph(
      ParagraphType.text,
  ...
  Paragraph(
      ...
      [
        Markup(MarkupType.bold, 18, 35, null),
        Markup(MarkupType.bold, 119, 130, null),
        Markup(MarkupType.bold, 168, 179, null),
        Markup(MarkupType.bold, 258, 267, null)
      ]),
  Paragraph(
      ParagraphType.text,
